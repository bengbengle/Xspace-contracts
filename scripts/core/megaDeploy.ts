...
//   const auction = await new Auction__factory(signer).deploy()

//   console.log('Auction:', auction.address)

//   const XspaceToken = await new Xspace__factory(signer).deploy()

//   console.log('Xspace Token:', XspaceToken.address)

//   const factory = await new Factory__factory(signer).deploy(XspaceToken.address)
